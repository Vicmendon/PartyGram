...
class FestaAdmin(admin.ModelAdmin):
    list_display = ('nome', 'data', 'organizador', 'total_convidados_display', 'total_confirmados_display', 'total_cervejeiros_display')
    list_filter = ('data', 'organizador')

    def total_convidados_display(self, obj):
        return obj.total_convidados()
    total_convidados_display.short_description = 'Total de Convidados'
